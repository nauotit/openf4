...
#ifndef OPENF4_IDEAL_H
#define OPENF4_IDEAL_H
...
namespace F4
{
    /**
     * \struct Stat.
     * \brief Structure used for statistics.
     */
    struct Stat
    {
        int _nbCp; /*!< Number of critical pairs */
        int _nbCpDeg; /*!< Number of critical pairs of the step degree */
        int _cmptGenPurg; /*!< Number of purged genarators */
        int _cmptNewGen; /*!< Number of new generators */
        clock_t _timePurgeCp; /*!< Time used to purge the critical pair (Buchberger criteria) */
        clock_t _timeAddCp; /*!< Time to add critical pair in the AVL of critical pairs */
        clock_t _timeMajBasis; /*!< Time to update the basis */
    ...
    class Ideal
    {
        ...
        private:
            ...
            std::vector<int> _total; /*!< Array of tagged polynomial index, _total[i] is a stored multiple of a basis polynomial */
