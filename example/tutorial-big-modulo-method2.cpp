...
/**
 *  \file tutorial-big-modulo-method2.cpp
 *  \example tutorial-big-modulo-method2.cpp
 *  \brief Tutorial with f4 library use with modulo >= 2^32. Use Givaro Modular<Integer> base type for element (based on GMP).
 *  \ingroup examples
...
int main (int argc, char **argv)
{
    ...
    vector<string> basis = groebnerBasisGivaroIntegerF4("115792089237316195423570985008687907853269984665640564039457584007913129640233", 6, variableName, polynomialArray, 1, 0);
