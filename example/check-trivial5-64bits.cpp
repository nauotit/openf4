...
/**
 *  \file check-trivial5-64bits.cpp
 *  \example check-trivial5-64bits.cpp
...
{
    cout << "#########################################################" << endl;
    cout << "#                CHECK TRIVIAL5 64 BITS                 #" << endl;
    cout << "#########################################################" << endl << endl;
    ...
    vector<string> basis= groebnerBasisF4(134218729, 1, variableName, polynomialArray, 1, 0);
    ...
    if(test==true)
    {
        cout << "Test trivial5 64 bits pass" << endl;
        return 0;
    }
    else
    {
        cout << "Test trivial5 64 bits failed" << endl;
        return -1;
    }
}
