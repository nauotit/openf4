...
/**
 *  \file check-trivial1-16bits.cpp
 *  \example check-trivial1-16bits.cpp
...
{
    cout << "#########################################################" << endl;
    cout << "#                CHECK TRIVIAL1 16 BITS                 #" << endl;
    cout << "#########################################################" << endl << endl;
    ...
    vector<string> basis= groebnerBasisF4(67, 1, variableName, polynomialArray, 1, 0);
    ...
    if(test==true)
    {
        cout << "Test trivial1 16 bits pass" << endl;
        return 0;
    }
    else
    {
        cout << "Test trivial1 16 bits failed" << endl;
        return -1;
    }
}
