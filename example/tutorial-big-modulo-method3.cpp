...
/**
 *  \file tutorial-big-modulo-method3.cpp
 *  \example tutorial-big-modulo-method3.cpp
 *  \brief Tutorial with f4 sources use for modulo >= 2^32. Use Givaro Modular<Integer> base type for element (based on GMP).
 *  \ingroup examples
