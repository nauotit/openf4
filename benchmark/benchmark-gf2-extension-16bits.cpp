...
/**
 *  \file benchmark-gf2-extension-16bits.cpp
 *  \example benchmark-gf2-extension-16bits.cpp
...
typedef ElementGF2Extension<uint16_t> eltType;
string modulo=string("t^15 + t^13 + t^8 + t^5 + t^2 + t + 1");
...
int randomIdealF4(bool magma)
{
    ...
    // Fill the polynomial array
    polRandomIdeal.emplace_back("(t^13 + t^11 + t^8 + t^7 + t^5 + t + 1)*x0^2*x1^3 + (t^12 + t^11 + t^10 + t^9 + t^8 + t^3)*x2^4*x4 + (t^14 + t^13 + t^9 + t^8 + t^5 + t^3 + t + 1)*x0*x2*x3^2*x5 + (t^14 + t^13 + t^10 + t^9 + t^7 + t^6 + t^2 + t)*x2^2*x3*x4*x5 + (t^14 + t^10 + t^9 + t^8 + t^7 + t^6 + t^2 + t)*x4^4*x5 + (t^8 + t^6 + t^5 + t^4)*x1^2*x3*x5^2 + (t^14 + t^13 + t^12 + t^9 + t^8 + t^7 + t^6 + t^5 + t^3 + t^2 + t + 1)*x0*x4^2*x5^2 + (t^14 + t^9 + t^8 + t^4 + t^3 + 1)*x1*x3^2*x4 + (t^12 + t^11 + t^9 + t^8 + t^7 + t^6 + t^5 + t^4 + t^3 + t)*x3^2 + (t^14 + t^13 + t^12 + t^8 + t^6 + t^2 + t + 1)*x4*x5");
    polRandomIdeal.emplace_back("(t^14 + t^10 + t^9 + t^8 + t^5 + t^4 + t^3 + t^2 + t)*x0^3*x1*x3 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^9 + t^6 + t)*x2^2*x3*x4^2 + (t^8 + t^7 + t^6 + t^5 + t^4 + t^2 + t + 1)*x1*x2*x3*x4*x5 + (t^11 + t^9 + t^6 + t^4 + t + 1)*x2*x3^2*x4*x5 + (t^13 + t^12 + t^9 + t^8 + t^6 + t^5 + t^4 + 1)*x1*x3*x4^2*x5 + (t^10 + t^9 + t^8 + t^7 + t^5 + t^4 + t^3 + t^2)*x2^2*x3^2 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^9 + t^8 + t^7 + t^6 + t^4 + t^3 + t^2 + 1)*x0^2*x2*x4 + (t^12 + t^11 + t^5 + 1)*x1*x4^3 + (t^14 + t^12 + t^6 + t^4 + t^3 + t)*x3*x4^3 + (t^13 + t^12 + t^11 + t^9 + t^8 + t^7 + t^5 + t^4 + t^3 + t^2 + t)*x0*x2^2*x5");
    polRandomIdeal.emplace_back("(t^14 + t^13 + t^10 + t^9 + t^6 + t^4 + t^3 + t^2 + t)*x0^4*x2 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^8 + t^7 + t^5 + t^4 + t + 1)*x0*x1^2*x4*x5 + (t^14 + t^9 + t^8 + t^5 + t^4 + t^2 + 1)*x2*x3^2*x4*x5 + (t^14 + t^13 + t^12 + t^9 + t^8 + t^7 + t^4 + t^2 + t)*x2*x3*x4^2*x5 + (t^13 + t^11 + t^10 + t^5 + t^2 + t + 1)*x1*x2*x4*x5^2 + (t^14 + t^12 + t^11 + t^9 + t^8 + t^6 + t^5 + t^3)*x0^2*x3^2 + (t^14 + t^13 + t^11 + t^9 + t^8 + t^7 + t^6 + t^5 + t^3 + t^2)*x3^3*x5 + (t^14 + t^12 + t^8 + t^7 + t^3 + t^2 + 1)*x1*x2*x5^2 + (t^13 + t^12 + t^8 + t^6 + t^5 + t^4 + t^3 + t^2 + t + 1)*x1^3 + (t^13 + t^12 + t^8 + t^7 + t^4 + t^2 + t)*x1^2*x2");
    polRandomIdeal.emplace_back("(t^11 + t^10 + t^9 + t^8 + t^6 + t^5 + t^4 + t^3 + 1)*x0^2*x3^3 + (t^14 + t^12 + t^11 + t^8 + t^7 + t^5 + t^4 + t^2 + 1)*x0^3*x3*x4 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^8 + t^5 + t^4 + t^3 + t^2 + t + 1)*x0^3*x4*x5 + (t^14 + t^12 + t^10 + t^5 + t^3 + 1)*x0^2*x2*x4*x5 + (t^9 + t^8 + t^5 + 1)*x0^2*x3*x4*x5 + (t^13 + t^9 + t^8 + t^7 + t^6 + t^5 + t^4 + 1)*x2*x4^3*x5 + (t^12 + t^10 + t^6 + t^4 + t^3 + 1)*x1*x3^2*x4 + (t^12 + t^9 + t^7 + t^5 + t^4 + t^3 + t^2 + t)*x0^2*x2 + (t^10 + t^8 + t^7 + t^6 + t^3 + t^2 + t)*x3^2*x5 + (t^14 + t^12 + t^9 + t^8 + t^4 + t^3 + t^2 + 1)*x5^2");
    polRandomIdeal.emplace_back("(t^14 + t^13 + t^12 + t^11 + t^10 + t^8 + t^7 + t^6 + t^5 + t^4 + t^2)*x1^4*x2 + (t^14 + t^13 + t^12 + t^11 + t^5 + t^4)*x1^3*x2^2 + (t^13 + t^12 + t^11 + t^10 + t^8 + t^5 + t^2 + 1)*x0^4*x4 + (t^14 + t^12 + t^10 + t^5 + t^3 + 1)*x1^3*x4^2 + (t^13 + t^12 + t^11 + t^10 + t^9 + t^8 + t^6 + t^5 + t^3 + 1)*x1*x3*x4^3 + (t^13 + t^10 + t^9 + t^4 + t + 1)*x0*x1^3 + (t^14 + t^13 + t^11 + t^8 + t^6 + t^3 + t + 1)*x0*x2*x5^2 + (t^14 + t^13 + t^7 + t^3 + t^2)*x1*x2*x4 + (t^14 + t^12 + t^9 + t^8 + t^6 + t^5 + t^4)*x2 + (t^14 + t^11 + t^10 + t^8 + t^7 + t^4)*x4");
    polRandomIdeal.emplace_back("(t^14 + t^13 + t^11 + t^6 + t^2 + t)*x2^2*x3^3 + (t^13 + t^10 + t^9 + t^7 + t^6 + t^4 + t^2 + t)*x1^2*x2*x4^2 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^4 + t^2 + t + 1)*x2^3*x3*x5 + (t^11 + t^10 + t^5 + t)*x0*x1*x3*x4*x5 + (t^14 + t^12 + t^11 + t^7 + t^6 + t^4 + t^2 + 1)*x2*x3^3 + (t^13 + t^11 + t^10 + t^7 + t^5 + t^4 + t)*x2^3*x4 + (t^14 + t^12 + t^9 + t^5 + t^3 + t^2 + 1)*x0*x3*x4*x5 + (t^14 + t^13 + t^12 + t^10 + t^7 + t^6 + t^5)*x1^2*x2 + (t^13 + t^8 + t^7 + t^6 + t^3 + t + 1)*x1^2*x4 + (t^13 + t^10 + t^9 + t^8 + t^7 + t^6 + t^3 + 1)*x0^2");
    polRandomIdeal.emplace_back("(t^14 + t^10 + t^9 + t^8 + t^7 + t^6 + t^4 + t^3 + 1)*x0^4*x1 + (t^14 + t^13 + t^12 + t^9 + t^8 + t^7 + t^6 + t^5 + t^3 + t^2 + 1)*x0^2*x1^2*x5 + (t^14 + t^13 + t^11 + t^10 + t^7 + t^6 + t^2 + t + 1)*x0*x1^3*x5 + (t^9 + t^6 + t^4 + t^3 + t^2 + t + 1)*x1*x3*x4^2*x5 + (t^11 + t^9 + t^8 + t^7 + t^5 + t^4 + t^3 + t)*x0*x2*x3^2 + (t^14 + t^13 + t^8 + t^7 + t^6 + t^5 + t^2 + 1)*x2^2*x3*x4 + (t^12 + t^10 + t^9 + t^5 + t^4 + t^3 + t^2 + 1)*x3^3 + (t^12 + t^11 + t^9 + t^7 + t^4 + t^2 + t)*x4^3 + (t^14 + t^11 + t^9 + t^8 + t^5 + t^4 + 1)*x2*x5^2 + (t^14 + t^11 + t^9 + t^7 + t^6 + t^3 + t^2 + t + 1)*x2*x3");
    polRandomIdeal.emplace_back("(t^14 + t^13 + t^10 + t^9 + t^6 + t^5 + t^4 + t^3 + 1)*x2*x4^4 + (t^14 + t^13 + t^12 + t^11 + t^10 + t^7 + t^4 + t^3 + t + 1)*x0^2*x2^2*x5 + (t^13 + t^12 + t^11 + t^6 + t^5 + t^4 + t^3 + t^2)*x0^2*x4*x5^2 + (t^14 + t^8 + t^7 + t^6 + t^5 + t^4 + t^3 + t^2)*x0*x3*x4*x5^2 + (t^13 + t^12 + t^11 + t^9 + t^8 + t^6 + t^2 + t)*x0*x2*x3^2 + (t^11 + t^8 + t^7 + t^6 + t)*x0*x3^3 + (t^14 + t^13 + t^9 + t^7 + t^3 + t^2 + t + 1)*x0*x1*x2*x4 + (t^13 + t^11 + t^10 + t^9 + t^8 + t^3 + 1)*x0*x1*x3*x4 + (t^14 + t^12 + t^10 + t^8 + t^7 + t^6 + t^5 + t^3 + t^2)*x0*x5^3 + (t^14 + t^13 + t^12 + t^9 + t^5 + t^4 + t^3 + t + 1)*x1*x5");
    polRandomIdeal.emplace_back("(t^14 + t^13 + t^11 + t^9 + t^6 + t^5 + t^4 + t^2 + t + 1)*x0*x1^4 + (t^12 + t^9 + t^8 + t^7 + t^2)*x0*x1*x3^3 + (t^12 + t^11 + t^10 + t^9 + t^7 + t^5 + t^4 + 1)*x0^3*x4^2 + (t^11 + t^9 + t^8 + t^6 + t^5 + t^4 + t^3 + t)*x0*x1^2*x3*x5 + (t^10 + t^8 + t^7 + t^6 + t^5 + t^4 + t^3 + t^2 + 1)*x1^2*x2*x3*x5 + (t^14 + t^7 + t^6 + t^5 + t^3 + t^2)*x1*x2*x4^2*x5 + (t^14 + t^13 + t^10 + t^9 + t^8 + t^6 + t^4 + t^3 + t^2 + t + 1)*x3^2*x4*x5^2 + (t^13 + t^12 + t^9 + t^8 + t^7 + t^5 + t^4 + t)*x0*x1^2*x3 + (t^13 + t^8 + t^5 + t^4 + t)*x2^3*x3 + (t^11 + t^9 + t^7 + t^6 + t^3 + t^2 + 1)*x0^3*x5");
    polRandomIdeal.emplace_back("(t^13 + t^11 + t^10 + t^8 + t^7 + t^6 + t^5 + t^4)*x2^2*x3*x4^2 + (t^14 + t^10 + t^9 + t^8 + t^6 + t^3 + t)*x2^2*x3^2*x5 + (t^14 + t^10 + t^8 + t^7 + t^3 + t^2 + t + 1)*x1*x3^2*x4*x5 + (t^12 + t^11 + t^9 + t^4 + 1)*x1^2*x4^2*x5 + (t^12 + t^11 + t^9 + t^7 + t^2 + 1)*x1*x3*x4*x5^2 + (t^13 + t^11 + t^10 + t^7 + t^6 + t^5)*x1^2*x4*x5 + (t^14 + t^12 + t^11 + t^9 + t^5 + t^4 + t)*x2*x5^3 + (t^10 + t^8 + t^6 + t^5 + t^3 + t^2)*x5^4 + (t^13 + t^12 + t^11 + t^8)*x2^2*x3 + (t^2 + t + 1)*x3^2*x5");
...
int main (int argc, char **argv)
{
    ...
    // File
    ofstream file("benchmark-gf2-16bits.txt");
    if (file)
    {
